...
{
    public partial class Revenue_and_Costs : Form
    {
        private DataTable dataTable;
        public Revenue_and_Costs()
        {
            InitializeComponent();
            ...
            // Ví dụ:
            dataTable.Rows.Add(1, "cough medicine, pain reliever", 2, 55000);
            dataTable.Rows.Add(2, "Boarding fees, medical supplies fees", 2, 30000);
            ...
            dataGridViewCost.DataSource = dataTable;
        }
    }
}
