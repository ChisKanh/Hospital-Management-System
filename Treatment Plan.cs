...
{
    public partial class Treatment_Plan : Form
    {
        ...
        public Treatment_Plan()
        {
            ...
            // Ví dụ:
            dataTable.Rows.Add(1, "My Ngoc", "Male", new DateTime(2003, 04, 10), "HIVAIDS", "Use Medicine", new DateTime(2024, 04, 10), new DateTime(2025, 07, 17));
            ...
            dataGridViewPlan.DataSource = dataTable;
        }
    }
}
