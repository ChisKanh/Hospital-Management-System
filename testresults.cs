...
namespace HostpitalManagerSystem
{
    public partial class testresults : Form
    {
        ...
        public testresults()
        {
            ...
            // Ví dụ:
            dataTable.Rows.Add(1, "My Ngoc", "Male", new DateTime(2003, 04, 10), "HIVAIDS", "Positive");
            //dataTable.Rows.Add(2, "Ly Gia Kiet", "Boy", new DateTime(1998, 09, 03), "Lung cancer", "Positive");
            ...
            dataGridViewTestResult.DataSource = dataTable;
        }
